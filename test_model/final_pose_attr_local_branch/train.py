...
from test_model.final_pose_attr_local_branch.data import build_final_train_loader, build_final_val_loader
from test_model.final_pose_attr_local_branch.model import create_final_pose_attr_model
...
def main():
    ...
    base_save = Path(cfg["training"].get("save_dir", "checkpoints/final_pose_attr_local_branch"))
    last_best = None
    ...
    if val_loader is not None and cfg.get("eval", {}).get("enabled", False):
        from test_model.final_pose_attr_local_branch.eval import evaluate_checkpoint
