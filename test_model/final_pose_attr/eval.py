...
from test_model.final_pose_attr.data import (  # noqa: E402
    AttrDataset,
    DetectDataset,
    PoseDataset,
    _resolve_root,
...
from test_model.final_pose_attr.model import create_final_pose_attr_model  # noqa: E402
...
def evaluate_checkpoint(cfg, weights, device="cuda", split="val",
    ...
    result = {
        "weights": str(weights),
        "config": str(Path(__file__).resolve().parent / "yaml/final_pose_attr.yaml"),
        "split": split,
