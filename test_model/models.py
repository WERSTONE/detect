...
class _DualHeadModel(_BaseModel):
    ...
    def compute_loss(self, images, gt_dict_list):
        ...
        # Loss
        det_l = self.det_loss(det_out, det_targets, self.strides, feat_sizes, head_type='det')
        pose_l = self.pose_loss(pose_out, pose_targets, self.strides, feat_sizes, head_type='pose')
