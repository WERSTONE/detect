...
class _BiFPNBlock(nn.Module):
    ...
    def __init__(self, ch, c2f_depth=2, use_p2=False):
        super().__init__()
        self.use_p2 = use_p2
...
class BiFPN(nn.Module):
    ...
    def __init__(self, in_channels, depth=0.67, width=0.75):
        ...
        # Keep the neck close to YOLOv8m capacity without overshooting too far.
        self.out_ch = make_divisible(c4 * (2.0 / 3.0))
        self.use_p2 = use_p2
